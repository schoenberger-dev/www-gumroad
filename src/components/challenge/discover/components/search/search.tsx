    ...
    <div className="relative">
      ...
      <AnimatePresence>
        {suggestionsOpen && (
          <motion.datalist
            className={cn(
              'absolute bottom-0 z-[1] block h-max w-full origin-top translate-y-[calc(100%-1px)] border border-t-0 border-foreground bg-white backdrop-blur *:border-b *:border-foreground before:pointer-events-none before:absolute before:left-0 before:top-0 before:block before:h-full before:w-full before:bg-white/85 before:opacity-0',
              isLoading && 'pointer-events-none before:opacity-100',
            )}
